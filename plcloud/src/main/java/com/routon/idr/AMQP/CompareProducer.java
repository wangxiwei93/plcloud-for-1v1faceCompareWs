...
/*		//queue
        ...
        logger.info("publish exchange = "+ FACE_IMAGE2_DATA_EXCHANGE + ", routingKey = " + FACE_IMAGE2_DATA_EXCHANGE_KEY + ", jobId = " + postJobId);
        System.out.println("publish exchange = "+ FACE_IMAGE2_DATA_EXCHANGE + ", routingKey = " + FACE_IMAGE2_DATA_EXCHANGE_KEY + ", jobId = " + postJobId);
